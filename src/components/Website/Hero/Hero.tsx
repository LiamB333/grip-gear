        ...
        <div className="flex flex-col self-start max-md:mt-10 max-md:max-w-full">
          <div className="flex flex-col text-black max-md:max-w-full">
            ...
            <p className="mt-6 text-lg leading-7 max-md:max-w-full">
              ...
              grip socks that reflect your style and personality. Whether you're
              an athlete looking for enhanced performance or just want to add a
              touch of flair to your game, our custom grip socks are the perfect
              choice.
            </p>
            <Button />
          </div>
