...
const Designer = () => {
  ...
  const calculatePriceAndSavings = useMemo(() => {
    ...
    if (quantity >= 150) {
      pricePerUnit = templatePrices[4][1];
    } else if (quantity >= 100) {
      pricePerUnit = templatePrices[3][1];
    } else if (quantity >= 50) {
      pricePerUnit = templatePrices[2][1];
    } else if (quantity >= 25) {
      pricePerUnit = templatePrices[1][1];
    }
