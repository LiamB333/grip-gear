...
const StepItem: React.FC<StepItemProps> = ({ icon, title, description, isLast, headingLevel }) => {
  ...
  return (
    <div className="flex flex-wrap gap-5 items-start w-full max-md:max-w-full">
      ...
      <div className="flex flex-col flex-1 shrink text-black basis-0 min-w-[240px] max-md:max-w-full">
        <HeadingTag className="text-xl font-bold leading-snug max-md:max-w-full">{title}</HeadingTag>
