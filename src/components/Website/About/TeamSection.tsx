...
const TeamSection: React.FC = () => {
  return (
    <>
      <section className="flex flex-col relative justify-center items-center bg-[#CB3A3A] md:px-16 pb-24">
        <header className="flex flex-col self-center max-w-full text-center text-white z-20 mt-36 md:mt-60 w-[768px]">
          <h1 className="text-5xl font-bold leading-[57.6px] -mt-20 max-md:max-w-full max-md:text-4xl">
            Meet Our Team
          </h1>
      ...
      <div className="relative z-0 -mt-[1px] md:block hidden">
        <svg
          width="100%"
          height="100%"
